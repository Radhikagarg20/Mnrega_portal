...
$chart = "C:\Users\MCL\3D Objects\mgnrega_portal\frontend\js\chart.min.js"
if (-not (Test-Path $chart)) {
  Invoke-WebRequest -Uri "https://cdn.jsdelivr.net/npm/chart.js/dist/chart.min.js" -OutFile $chart
}
